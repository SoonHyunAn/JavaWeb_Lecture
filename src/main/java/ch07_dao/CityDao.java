package ch07_dao;
/*
 * Web 에서 DB를 엑세스하는 방법 : DBCP
 * 
 * 	1. webapp/WEB-INF/lib에 database library (.jar) 추가
 * 	2. Tomcat server의 context.xml에 database 연결을 위한 수정 필요
 * */
...
public class CityDao {
	...
	public Connection getConnection() {
		...
		try {
			...
			DataSource ds = (DataSource) initContext.lookup("java:comp/env/" + "jdbc/world"); // context에 추가한 부분의 name
