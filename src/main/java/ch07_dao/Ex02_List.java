...
public class Ex02_List extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String html = "<!DOCTYPE html>" + "<html>" + "<head>" + "<meta charset=\"UTF-8\">" + "<title>City List</title>"
				+ "<style>" + "th, td {" + "	padding: 3px;" + "}" + "</style>" + "</head>"
				+ "<body style=\"margin: 50px;\">" + "	<h1>City List</h1>" + "	<hr>" + "	<table border=\"1\">"
				+ "		<tr>" + "		<th>아이디</th>" + "		<th>도시명</th>" + "		<th>국가코드</th>"
				+ "		<th>지역명</th>" + "		<th>인구</th>" + "		</tr>";
		html += data;
