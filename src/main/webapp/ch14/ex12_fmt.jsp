...
<body style="margin: 50px">
	...
	<table border="1">
		...
		<tr><td>천단위 구분 기호</td><td><fmt:formatNumber type="number" value="${price}" /></td></tr>
		<tr><td>천단위 구분 기호 (type 생략 가능)</td><td><fmt:formatNumber value="${price}" /></td></tr>
		...
		<tr><td>pattern("YYYY-MM-DD HH:mm:ss")</td><td><fmt:formatDate pattern="YYYY-MM-DD HH:mm:ss" value="${now}" /></td>
		<tr><td>pattern("YYYY-MM-DD HH:mm")</td><td><fmt:formatDate pattern="YYYY-MM-DD HH:mm" value="${now}" /></td>
		</tr>
	</table>
</body>
</html>