...
<body>
	...
	<div class="container" style="margin-top: 80px">
		<div class="row">
			...
			<div class="col-9">
				<h3>
					<strong class="me-5">게시글 목록</strong> <span style="font-size: 16px;">
					<a href="/jw/bbs/board/insert"><i class="fa-solid fa-pen-to-square"></i>글쓰기</a></span>
				</h3>
				<hr>
				<table class="table">
					<tr>
					...
					<c:forEach var="board" items="${boardList}">
						<tr>
							<td>${board.bid}</td>
							<td>
								<a href="/jw/bbs/board/detail?bid=${board.title}" > ${board.title} </a>
